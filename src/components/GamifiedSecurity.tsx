...
import { X, Zap, Trophy, Brain } from 'lucide-react';
...
export default function GamifiedSecurity() {
  ...
  const [lessons, setLessons] = useState<LearningPopup[]>([
    {
      id: 'left',
      title: 'Private Relay',
    ...
    const handleKeyPress = (e: KeyboardEvent) => {
      ...
      switch (e.key.toLowerCase()) {
        ...
        case 'a':
          ...
          lesson = lessons[0]; // Private Relay
          break;
        case 'arrowright':
        case 'd':
          newPosition = Math.min(90, carPosition + 15);
          lesson = lessons[1]; // 2FA
          break;
        case 'arrowup':
        case 'w':
          lesson = lessons[2]; // Smart Contract Audit
          break;
        case 'arrowdown':
        case 's':
          lesson = lessons[3]; // Threat Detection
          break;
        default:
          return;
      }
  ...
  }, [carPosition, gameActive, lessons]);
  ...
  return (
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 bg-black">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Game Track */}
        <div className="bg-gradient-to-br from-gray-900 to-black border-2 border-red-600/30 rounded-2xl p-8 mb-8">
          {/* Track Background */}
